 ...
 */
public class CourbeVitesseFragment extends FragmentCourbe
{
	/***
	 ...
	 * @return
	 */
	public static CourbeVitesseFragment newInstance(final @NonNull Itineraire itineraire)
	{
		CourbeVitesseFragment fragment = new CourbeVitesseFragment();
			...
			if (cursor.getCount() > 0)
			{
				...
				while (cursor.moveToNext())
				{
					...
					if ( precedente != null)
					{
						...
						float distance = position.getHorizontalDistance(precedente) ;
